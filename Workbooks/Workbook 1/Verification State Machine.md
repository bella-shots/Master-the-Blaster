...
Every AC1–AC17 and ZBA-01–ZBA-07 item MUST have exactly one state:
...
- AC15 = PASS only after a mechanical audit proves every current PASS has complete evidence.
