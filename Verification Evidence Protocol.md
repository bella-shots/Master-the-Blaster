...
| **AC5** | Actual/emulator allowed + denied authorization tests. | Role-based rules drafted in `firestore.rules`; emulator/live execution pending Phase 3. | `firestore.rules`<br>2026-09-20T01:20 | Rules drafted; automated test suite execution scheduled in Phase 3. | ZBA-03: OPEN (Blocks AC5) | Consistent with ZBA-03 | **OPEN** |
...
| **AC10** | Final gate verification: all P0 criteria PASS before completion. | Evaluated completion formula. Phase 1 remains IN PROGRESS / LOCKED. | Acceptance Gate<br>2026-09-20T01:20 | AC2–AC8, AC10–AC13, AC15–AC17 and ZBA-01–07 remain OPEN awaiting gates/tests. | AC1..AC17: Incomplete | Required by formula | **OPEN** |
...
| **AC12** | ZBA-01..ZBA-07 evidence-backed PASS. | Evaluated ZBA ledger; all 7 ZBA items remain OPEN awaiting live gates and test executions. | ZBA Ledger<br>2026-09-20T01:20 | All 7 ZBA items OPEN awaiting live gates and test executions. | ZBA-01..07: Incomplete | Consistent with ZBA ledger | **OPEN** |
...
| **AC15** | Mechanical audit of every PASS. | Audited remaining PASS rows against Evidence Artifact Registry; meta-audit criterion. | Verification Ledger<br>2026-09-20T01:20 | Downgraded to OPEN: meta-audit criterion cannot certify itself while items remain OPEN. | Registry in progress | No contradiction | **OPEN** |
...
| **ZBA-07** | End-to-End Invariant | Reconcile all dependencies; derived strictly from ZBA-01..06. | All 6 required upstream ZBA items remain OPEN. | Requires ZBA-01 through ZBA-06 all PASS. | Cannot be PASS while ZBA-01..06 OPEN | **OPEN** | Awaits ZBA-01..06 resolution |
